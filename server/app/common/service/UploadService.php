...
class UploadService
{
     ...
     */
    public static function image($cid, int $adminId = 0, int $sourceId = 0, int $source = FileEnum::SOURCE_ADMIN, string $saveDir = 'uploads/images')
    {
        try {
            $config = [
     ...
     */
    public static function video($cid, int $adminId = 0, int $sourceId = 0, int $source = FileEnum::SOURCE_ADMIN, string $saveDir = 'uploads/video')
    {
        try {
            $config = [
                'default' => ConfigService::get('storage', 'default', 'local'),
     ...
     * @date 2023/06/26
     */
    public static function file($cid, int $adminId = 0, int $sourceId = 0, int $source = FileEnum::SOURCE_ADMIN, string $saveDir = 'uploads/file')
    {
