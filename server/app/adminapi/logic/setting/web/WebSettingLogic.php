...
class WebSettingLogic extends BaseLogic
{
    ...
    public static function getWebsiteInfo(): array
    {
        return [
            ...
            'service_image' => FileService::getFileUrl(ConfigService::get('website', 'service_image')),
    ...
    public static function setWebsiteInfo(array $params)
    {
        ...
        $service = FileService::setFileUrl($params['service_image']);
        ...
        ConfigService::set('website', 'service_image', $service);
