...
class WorkbenchLogic extends BaseLogic
{
    ...
    public static function menu(): array
    {
        return [
            ...
            [
                'name' => '查看绩效',
                'image' => FileService::getFileUrl(config('project.default_image.ckjx')),
                'url' => '/work/user/performance'
            ],
            [
                'name' => '个人中心',
                'image' => FileService::getFileUrl(config('project.default_image.grzx')),
                'url' => 'work/workbench/user_index'
            ],
            [
                'name' => '下载表单',
                'image' => FileService::getFileUrl(config('project.default_image.xzbd')),
                'url' => '/work/user_work_file'
            ],
            [
                'name' => '周报审核',
                'image' => FileService::getFileUrl(config('project.default_image.zbsh')),
                'url' => '/team/admin_weekly_report'
            ],
            [
                'name' => '人员管理',
                'image' => FileService::getFileUrl(config('project.default_image.xzry')),
                'url' => '/team/admin'
            ],
        ];
    }
