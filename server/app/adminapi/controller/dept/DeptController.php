...
class DeptController extends BaseAdminController
{
    ...
    public function delete()
    {
        ...
        $DeptName = Dept::where(['id'=>$params['id']])->value('name');
    ...
    {
        $result = DeptLogic::getAllData();
        return $this->data($result[0]['children']);
    }
    ...
    {
        $deptLists = Dept::field(['id', 'name'])->where(['pid'=>1])->select()->toArray();
        array_unshift($deptLists, ['id' => 0, 'name' => '全部']);
        return $this->data($deptLists);
    }
