...
<!--                    </el-table-column>-->
                    ...
                    <el-table-column label="登录账号" prop="account" min-width="180" />
                    <el-table-column
                        label="任职岗位"
                        prop="jobs_name"
                        min-width="100"
...
<!--                    <el-table-column label="创建时间" prop="create_time" min-width="180" />-->
                    <el-table-column label="入职时间" prop="entry_time" min-width="180" />
<!--                    <el-table-column label="最近登录时间" prop="login_time" min-width="180" />-->
<!--                    <el-table-column label="最近登录IP" prop="login_ip" min-width="120" />-->
                    <el-table-column label="在职状态" prop="disable_desc" min-width="100" />
...
import {adminEdit, adminLists, adminDisable, adminDelete} from '@/api/perms/admin'
...
import {deptAll, deptAll2} from "@/api/org/department";
...
// 抽屉相关
import InfoPopup from "@/views/permission/admin/info.vue";
